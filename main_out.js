...
(function(window_, jQuery) {
  var X_Old = 0;
    ...
    DIST_ = Math.floor(Math.sqrt( xs + ys ));
		MASS_ = Math.floor((Size_*Size_)/100);
		//console.log("Mass: "+Size_+" Dist: "+dist);
    ...
    function draw() {
        ...
        if (0 != closingAnimationTime) {
            ...
            button2.setValue("Mass: "+MASS_+" Dist: "+DIST_);
            d = button2.render();
            w = d.width;
            ctx.globalAlpha = 0.4;
            ctx.fillStyle = "#000000";
